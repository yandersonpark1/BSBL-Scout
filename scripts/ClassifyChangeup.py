...
class ClassifyChangeup:
    def __init__(self, file_or_df):
        ...
        self.df_fb = self.df[self.df["Pitch Type"].str.contains("Fastball|2S|Ct", case = False, na=False, regex = True)].copy()
        ...
        self.df_CH = self.df[self.df["Pitch Type"].str.contains("ChangeUp", na=False)].copy()
